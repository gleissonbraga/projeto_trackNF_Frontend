...
import { cleanCNPJ } from "../utils/clean/cleanCnpj";
import { formatCNPJInput } from "../utils/format/formatCnpjInput";
    ...
    <div className="fixed inset-0 bg-black backdrop-blur-[1.6px] bg-opacity-50 flex items-center justify-center z-50">
      <div className="bg-white p-6 rounded-lg w-[60%] h-[600px]  shadow-lg relative flex flex-col  items-center justify-center gap-4">
        ...
        <div className="flex flex-col items-center">
          ...
          <p className="text-center text-xl font-semibold mb-4 w-[60%] text-gray-600">
            Crie sua conta e comece a gerenciar o recebimento das suas notas
            fiscais
          </p>
        </div>
        {erro.show && (
          <p className="absolute top-40 left-6 bg-red-100 border border-red-400 text-red-700 px-4 py-2 rounded shadow-md text-sm z-50 w-auto">
            {erro.show}
          </p>
        )}
          ...
          >
            <div className="flex gap-4 w-full items-center">
              ...
              <div className="flex flex-col gap-2 w-[50%]">
                <h3 className="text-center text-2xl mb-4 text-blue-600">
                ...
                <input
                  ...
                  value={fantasy_name}
                  onChange={(e) => setFatasyName(e.target.value)}
                  className="border-b-2 p-2 w-[98%] border-gray-600 h-10"
                />
                <input
                  type="text"
                ...
                <div className="flex gap-2">
                  <input
                    ...
                    placeholder="CNPJ"
                    maxLength={18}
                    value={formatCNPJInput(cnpjInput)}
                ...
                {(erro.state_registration || erro.cnpj) && (
                  <span className="text-red-500 text-xs text-center">
                    {erro.state_registration || erro.cnpj}
                  </span>
                )}
            ...
            <div className="flex flex-col gap-4 w-[50%] mt-6 items-center">
              <button type="submit" className="bn39">
