...
export default function DetailsTickets({ onClose, ticket }: TicketsListProps) {
            ...
            <div className="flex w-[90%] mt-4">
              <div className="w-[100%]  flex flex-col gap-4 pl-2 pt-6">
                ...
                <div>
                  ...
                  <h3 className="text-base font-semibold text-[#374151] break-all">
                    {formatDate(ticket.nf_received.date_now)}
                  </h3>
                </div>
                <div>
                  <p className="text-sm text-[#6b7280] font-medium mb-2">
                  ...
                  <h3 className="text-2xl font-bold text-green-700 break-all">
                    {formatMoney(ticket.nf_received.nf_value)}
                  </h3>
                </div>
                <div>
                  <p className="text-sm text-[#6b7280] font-medium mb-2">
            ...
            <div className="flex w-[90%] mt-4">
              <div className="w-[100%]  flex flex-col gap-4 pl-2 pt-6">
                ...
                <div>
                  ...
                  <h3 className="text-base font-semibold text-[#374151] break-all">
                    {formatCNPJ(ticket.nf_received.supplier.cnpj)}
                  </h3>
                </div>
                <div>
                  <p className="text-sm text-[#6b7280] font-medium mb-2">
                  ...
                  <h3 className="text-base font-semibold text-[#374151] break-all">
                    {ticket.nf_received.supplier.state_registration}
                  </h3>
                </div>
                <div>
                  <p className="text-sm text-[#6b7280] font-medium mb-2">
                  ...
                  <h3 className="text-base font-semibold text-[#374151] break-all">
                    {`${ticket.nf_received.supplier.phone_number == '' ? '(00) 00000-0000' : formatPhone(ticket.nf_received.supplier.phone_number)} / ${ticket.nf_received.supplier.email}`}
                  </h3>
                </div>
              </div>
            </div>
